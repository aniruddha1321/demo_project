...
class GradeCalculator:
    ...
    def curved_score(self, score: float, class_avg: float, target_avg: float = 75.0) -> float:
        if class_avg == 0:
            return score
    ...
    def needs_improvement(self, student: Student, threshold: float = 70.0) -> List[Tuple[str, float]]:
